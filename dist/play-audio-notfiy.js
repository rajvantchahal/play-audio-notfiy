;(function(process){  require.m = { 0:[function(require,module,exports){ window.playAudio = require('./');
 ...
 },{"./lib/player":2}],2:[function(require,module,exports){ var newChain  = require('new-chain-notify'),
    src = require('./src'),
...
function play(urls, dom){
 ...
 },{"./src":3,"./render":5,"new-chain-notify":8}],3:[function(require,module,exports){ var mimeOf = require("./mime");
